...
imports = [
  ...
  home.file.".config/lite-xl/init.lua".source = config.lib.file.mkOutOfStoreSymlink "${config.home.homeDirectory}/nix-hm/config/lite-xl/init.lua";
  xdg.configFile = { ".config/lite-xl/colors/colors.lua".text = ''
